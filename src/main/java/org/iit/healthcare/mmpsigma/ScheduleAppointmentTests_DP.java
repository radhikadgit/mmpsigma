...
public class ScheduleAppointmentTests_DP {
	...
	public void validateScheduleAppointment()
	{
        ...
        String expectedDocName = "Charlie";
        expectedHMap.put("opener", expectedDocName);
        String actualDocName = driver.findElement(By.xpath("//table[@class='table']/tbody/tr[1]/td[4]")).getText();
        actualHMap.put("opener", actualDocName);
